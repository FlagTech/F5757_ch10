    ...
    def search_tasks(self, keyword: str) -> None:
        ...
        try:
            ...
            for i, task in enumerate(tasks, 1):
                ...
                status_display = status_styles.get(status, f"❓ {status}")
                priority_display = priority_styles.get(priority, f"⚪ {priority}")

                # 框線設計
                print(f"┌──────────────── 任務 #{i} ────────────────┐")
                print(f"│ 🆔 ID: {task_id:<4} 📝 標題: {title[:25]:<25} │")
                if len(title) > 25:
                    print(f"│              {title[25:]:<35} │")
                print(f"│ ━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━ │")
                print(f"│ 📄 描述: {(desc or '(無描述)')[:35]:<35} │")
                if desc and len(desc) > 35:
                    print(f"│          {desc[35:70]:<35} │")
                print(f"│ ━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━ │")
                print(f"│ {priority_display:<12} │ {status_display:<15} │")
                print(f"└──────────────────────────────────────────┘")
                print()
